...
namespace PDL.ReportService.Interfaces.Interfaces
{
    public interface IReports
    {
        ...
        List<SmWithoutChqVM> GetLoansWithoutInstallments(string dDbName, string dbName, bool isLive, int PageNumber, int PageSize);
        ...
        List<CSOReportVM> GetCSOReport(int creatorId, string branchCode, string dbName, bool isLive);
